function RepairMod:usePillOrigin(pills)
	...
	if pills == PillEffect.PILLEFFECT_AMNESIA then
		if player:GetPillRNG(PillEffect.PILLEFFECT_AMNESIA):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
	...
	elseif pills == PillEffect.PILLEFFECT_QUESTIONMARK then
		if player:GetPillRNG(PillEffect.PILLEFFECT_QUESTIONMARK):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(287,false,true,false,false)
		end
	...
	elseif pills == PillEffect.PILLEFFECT_PARALYSIS then
		if player:GetPillRNG(PillEffect.PILLEFFECT_PARALYSIS):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(510,false,true,false,false)
			player:UseActiveItem(510,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_POWER then
		if player:GetPillRNG(PillEffect.PILLEFFECT_POWER):RandomInt(20) < (14 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(160,false,true,false,false)
			player:UseActiveItem(160,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_WIZARD then
		if player:GetPillRNG(PillEffect.PILLEFFECT_WIZARD):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(160,false,true,false,false)
			player:UseActiveItem(160,false,true,false,false)
			player:UseActiveItem(192,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_X_LAX then
		if player:GetPillRNG(PillEffect.PILLEFFECT_X_LAX):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(291,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_SOMETHINGS_WRONG then
		if player:GetPillRNG(PillEffect.PILLEFFECT_SOMETHINGS_WRONG):RandomInt(20) < (14 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(291,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_PHEROMONES then
		if player:GetPillRNG(PillEffect.PILLEFFECT_PHEROMONES):RandomInt(20) < (20 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(510,false,true,false,false)
			player:UseActiveItem(510,false,true,false,false)
			player:UseActiveItem(510,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_HEMATEMESIS then
		if player:GetPillRNG(PillEffect.PILLEFFECT_HEMATEMESIS):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(536,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_RETRO_VISION then
		if player:GetPillRNG(PillEffect.PILLEFFECT_RETRO_VISION):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(287,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_LARGER then
		if player:GetPillRNG(PillEffect.PILLEFFECT_LARGER):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(515,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_PUBERTY then
		if player:GetPillRNG(PillEffect.PILLEFFECT_PUBERTY):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(297,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_BAD_TRIP then
		if player:GetPillRNG(PillEffect.PILLEFFECT_BAD_TRIP):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(515,false,true,false,false)
		end
	elseif pills == PillEffect.PILLEFFECT_INFESTED_QUESTION then
		if player:GetPillRNG(PillEffect.PILLEFFECT_INFESTED_QUESTION):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
	...
	elseif pills == PillEffect.PILLEFFECT_INFESTED_EXCLAMATION then
		if player:GetPillRNG(PillEffect.PILLEFFECT_INFESTED_EXCLAMATION):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
	...
	elseif pills == PillEffect.PILLEFFECT_I_FOUND_PILLS then
		if player:GetPillRNG(PillEffect.PILLEFFECT_I_FOUND_PILLS):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
	...
	elseif pills == PillEffect.PILLEFFECT_RELAX then
		if player:GetPillRNG(PillEffect.PILLEFFECT_RELAX):RandomInt(20) < (10 + player.Luck) then --0부터 9 / 4 + 럭 미만
			player:UseActiveItem(291,false,true,false,false)
		end
	end
end
